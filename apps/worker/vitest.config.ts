...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@saas-contabil/credentials': path.resolve(__dirname, '../../packages/credentials/src/index.ts'),
      '@saas-contabil/scraper': path.resolve(__dirname, '../../packages/scraper/src/index.ts'),
      '@saas-contabil/normalizer': path.resolve(__dirname, '../../packages/normalizer/src/index.ts'),
      '@saas-contabil/conciliation': path.resolve(__dirname, '../../packages/conciliation/src/index.ts'),
      ...
      '@saas-contabil/notifications': path.resolve(__dirname, '../../packages/notifications/src/index.ts'),
    },
  },
  test: {
    globals: true,
